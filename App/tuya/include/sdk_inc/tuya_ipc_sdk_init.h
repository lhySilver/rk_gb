...
typedef struct
{
    ...
    GET_WF_NW_STAT_CB wf_status_changed_cb; /* status change callback function for developer, could be NULL if not needed */
#endif
    TUYA_IPC_SDK_UPGRADE_S  upgrade_cb_info;/* OTA callback function, triggered by uprading from APP and TUYA cloud */
