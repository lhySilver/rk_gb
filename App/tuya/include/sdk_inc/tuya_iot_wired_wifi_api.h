...
***********************************************************/
__TUYA_IOT_WIRED_WIFI_API_EXT \
OPERATE_RET tuya_iot_wired_wifi_mcu_dev_init(IN CONST IOT_GW_NET_TYPE_T net_mode,
                                     IN CONST GW_WF_CFG_MTHD_SEL cfg, IN CONST GW_WF_START_MODE start_mode,
...
#define tuya_iot_wired_wifi_soc_dev_init(net_mode, cfg, start_mode,cbs,product_key,wf_sw_ver) \
        tuya_iot_wired_wifi_soc_dev_init_param(net_mode, cfg, start_mode,cbs,NULL,product_key,wf_sw_ver)

__TUYA_IOT_WIRED_WIFI_API_EXT \
OPERATE_RET tuya_iot_wired_wifi_soc_dev_init_param(IN CONST IOT_GW_NET_TYPE_T net_mode,
                                     IN CONST GW_WF_CFG_MTHD_SEL cfg, IN CONST GW_WF_START_MODE start_mode,
                                     IN CONST TY_IOT_CBS_S *cbs,IN CONST CHAR_T *firmware_key,
...
__TUYA_IOT_WIRED_WIFI_API_EXT \
OPERATE_RET tuya_iot_reg_get_wired_wifi_nw_stat_cb_params(IN CONST GET_NW_STAT_CB nw_stat_cb, IN CONST GET_WF_NW_STAT_CB wf_nw_stat_cb, IN CONST INT_T min_interval_s);
...
***********************************************************/
__TUYA_IOT_WIRED_WIFI_API_EXT \
OPERATE_RET tuya_iot_wired_wifi_gw_fast_unactive(IN CONST GW_WF_CFG_MTHD_SEL mthd,IN CONST GW_WF_START_MODE wifi_start_mode);
...
***********************************************************/
__TUYA_IOT_WIRED_WIFI_API_EXT \
OPERATE_RET tuya_iot_gw_wired_wifi_user_cfg(IN CONST CHAR_T *ssid,IN CONST CHAR_T *passwd,IN CONST CHAR_T *token);
