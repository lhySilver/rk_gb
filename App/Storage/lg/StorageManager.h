...
typedef record_file_time_s record_file_info_s;
...
private:
	...
	int GetAlarmRecIndexFilePath(int iUnixTimestamp, char *path);
	int do_save_sps_pps();
	int do_read_sps_pps();
...
public:
	...
	Int32 SearchRecord(Int32 year, Int32 month, Int32 day, TRecordFileTimeList &listRecordTimeInfo, TRecordFileTimeList &listAlarmRecordTimeInfo);
