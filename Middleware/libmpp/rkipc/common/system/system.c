...
int rk_system_reboot() {
	printf("\033[1;35m     rk_system_reboot     \033[0m\n");
	system("reboot");
	return 0;
}

int rk_system_factory_reset() {
	printf("\033[1;35m     rk_system_factory_reset     \033[0m\n");
...
int rk_system_import_db(const char *path) {
	printf("\033[1;35m     rk_system_import_db     \033[0m\n");
	char cmd[128] = {'\0'};
...
int rk_system_upgrade(const char *path) {
	printf("\033[1;35m     rk_system_upgrade     \033[0m\n");
	char cmd[128] = {'\0'};
	if (path)
