...
/*流类型 视频*/
#define DMC_MEDIA_VIDEO_MAIN_STREAM 	(1<<0) /*主码流*/
#define DMC_MEDIA_VIDEO_SUB_STREAM  	(1<<1) /*子码流*/
#define DMC_MEDIA_VIDEO_THIRD_STREAM    (1<<2) /*第三码流*/
#define DMC_MEDIA_VIDEO_SNAP_STREAM     (1<<3) /*抓图流*/

/*流类型 音频*/
#define DMC_MEDIA_AUDIO_FRIST_STREAM 	 (1<<8)
#define DMC_MEDIA_AUDIO_SECOND_STREAM    (1<<9)
#define DMC_MEDIA_AUDIO_THIRD_STREAM     (1<<10)
