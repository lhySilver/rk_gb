#ifndef _ALAW_ENCODER_H_
#define _ALAW_ENCODER_H_
...
static unsigned char linear2alaw(signed short l)
{
	unsigned char	mask;
...
static signed short	alaw2linear(unsigned char a)
{
	return(_A2l[a]);
}
...
static int	g711a_Encode( char *src, char *dest, int srclen, int *dstlen)
{
	int	i,tmp;
//	char dest_data;
...
static int g711u_Decode( unsigned char *src, char *dest, int srclen, int *dstlen)
{
	int	i;
...
static int	g711u_Encode( char *src, char *dest, int srclen, int *dstlen)
{
	int	i,tmp;
//	signed short src_data;
//	unsigned char	mask;
