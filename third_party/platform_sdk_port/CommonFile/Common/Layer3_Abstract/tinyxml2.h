...
public:
    ...
    static bool ToULongLong( const char* str, unsigned long long* value );
...
public:
    ...
    */
    ...
    XMLError QueryLongLongText( long long* llval ) const;
    XMLError QueryULongLongText( unsigned long long* ullval ) const;
