//跨平台C++ Des加密类
#ifndef _DES_ENCRYPTOR_H_
#define _DES_ENCRYPTOR_H_
#include <string>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
public:
	...
	void Des_EncryptText_Bin(char* text,string key, unsigned long len);
	//解密二进制内存区
	void Des_DecryptText_Bin(char* text,string key, unsigned long len);
