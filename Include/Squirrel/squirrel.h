...
#define SQUIRREL_OP(op)	\
	do	\
	{	\
		int top = sq_gettop(m_VM);	\
		sq_pushroottable(m_VM);	\
		sq_pushstring(m_VM, op,-1);	\
...
#define SQUIRREL_OP1(op, int1)	\
	...
	{	\
		sq_pushroottable(m_VM);	\
		sq_pushinteger(m_VM, int1);	\
		sq_call(m_VM, 2, FALSE, TRUE);	\
	}	\
		sq_settop(m_VM,top);	\
	} while(0)


#define SQUIRREL_OP2(op, int1, int2)	\
	do	\
	{	\
		int top = sq_gettop(m_VM);	\
		sq_pushroottable(m_VM);	\
	...
	{	\
		sq_pushroottable(m_VM);	\
		sq_pushinteger(m_VM, int1);	\
		sq_pushinteger(m_VM, int2);	\
		sq_call(m_VM, 3, FALSE, TRUE);	\
	}	\
		sq_settop(m_VM,top);	\
	} while(0)


#define SQUIRREL_OP3(op, int1, int2, int3)	\
	do	\
	{	\
		int top = sq_gettop(m_VM);	\
		sq_pushroottable(m_VM);	\
	...
	{	\
		...
		sq_pushinteger(m_VM, int1);	\
		sq_pushinteger(m_VM, int2);	\
		sq_pushinteger(m_VM, int3);	\
		sq_call(m_VM, 4, FALSE, TRUE);	\
	}	\
		sq_settop(m_VM,top);	\
	} while(0)


#define SQUIRREL_OP1_EX(op, str1)	\
	do	\
	{	\
		int top = sq_gettop(m_VM);	\
		sq_pushroottable(m_VM);	\
		sq_pushstring(m_VM, (const SQChar *)op,-1);	\
		if(SQ_SUCCEEDED(sq_get(m_VM,-2)))	\
	{	\
		sq_pushroottable(m_VM);	\
		sq_pushstring(m_VM, (const SQChar *)str1, strlen((const char *)str1));	\
		sq_call(m_VM, 2, FALSE, TRUE);	\
	}	\
		sq_settop(m_VM,top);	\
	} while(0)
