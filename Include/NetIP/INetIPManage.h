#ifndef _INETIP_MANAGE_H_
#define _INETIP_MANAGE_H_

#include "Manager/User.h"
#include "Manager/EventManager.h"
#include "ExchangeAL/NetIPOperation.h"
...
public:
	...
	static INetIPManage *instance();

	/// 虚析构函数
	virtual ~INetIPManage();
	...
	//查询NatServer 注册的相关关状态
	virtual int GetNatStatus(NatStatusInfo &statusInfo ) = 0;
