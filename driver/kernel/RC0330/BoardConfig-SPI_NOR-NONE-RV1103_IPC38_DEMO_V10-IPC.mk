...
export RK_KERNEL_DEFCONFIG_FRAGMENT=rv1106-ipc.config

# Kernel dts
export RK_KERNEL_DTS=rv1103g-38x38-ipc-v10.dts
...
export RK_CAMERA_SENSOR_IQFILES="gc2053_CMK-OT2274-V10_28IRC-F20.json gc2053_CMK-OT2274-V11_28IRC-F20-1.json"
...
export RK_PARTITION_CMD_IN_ENV="64K(env),128K@64K(idblock),256K(uboot),3M(boot),3M(rootfs),9M(oem),-(userdata)"
