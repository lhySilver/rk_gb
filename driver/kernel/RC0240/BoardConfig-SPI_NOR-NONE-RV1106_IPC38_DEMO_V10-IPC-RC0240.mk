...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rv1106-spi-nor-rc0240_defconfig

# Uboot defconfig fragment
export RK_UBOOT_DEFCONFIG_FRAGMENT=rk-sfc-rc0240.config

# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rv1106_defconfig

# Kernel defconfig fragment
export RK_KERNEL_DEFCONFIG_FRAGMENT=rv1106-ipc-rc0240.config

# Kernel dts
export RK_KERNEL_DTS=rv1106g-38x38-ipc-rc0240-v10.dts
...
export RK_PARTITION_CMD_IN_ENV="64K(env),128K@64K(idblock),256K(uboot),3M(boot),6M(rootfs),6M(oem),-(userdata)"
